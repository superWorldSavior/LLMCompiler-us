...
def get_dataset(args):
    dataset_name = "llmcompiler/datasets/"
    if args.benchmark_name == "movie":
        dataset_name = "llmcompiler/datasets/movie_recommendations_formatted.json"
    elif args.benchmark_name == "hotpotqa":
        dataset_name = "llmcompiler/datasets/hotpotqa_comparison.json"
    elif args.benchmark_name == "parallelqa":
        dataset_name = "llmcompiler/datasets/parallelqa_dataset.json"
...
async def main():
    ...
    if os.path.exists(args.store):
        try:
            ...
            print(f"Warning: {args.store} is corrupted, starting with empty results")
            all_results = {}
    ...
    for i, example in enumerate(dataset):
        ...
        if str(id) not in all_results:
            ...
            print(f"Expected Answer (label): {label}")
